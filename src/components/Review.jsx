...
const isFormValid =
  ...
  return (
    <div className="review-section w-full max-w-md md:max-w-xl lg:max-w-2xl mx-auto px-2 md:px-8 lg:px-16">
      <h3 className="text-lg md:text-xl font-semibold mb-4">REVIEW YOUR DETAILS</h3>
      <div className="flex flex-col md:flex-row items-start gap-4 mb-4">
        {/* Profile Image */}
        <div className="relative w-14 h-14 md:w-20 md:h-20 rounded-full overflow-hidden bg-green-700 text-white flex items-center justify-center text-2xl md:text-3xl font-semibold">
          {profileImage ? (
            <img
              src={profileImage}
              alt="Profile"
        ...
        <div className="flex-1">
          ...
          {/* Verification Info */}
          <div>
            <h3 className='font-black-bold mb-1 text-base md:text-lg'>Let's verify your account</h3>
          ...
          <div className='w-full flex gap-1 border border-gray-300 rounded'>
            <span className="px-3 py-2 text-sm inline">+91</span>
            <input
              type="tel"
              value={mobileNumber}
